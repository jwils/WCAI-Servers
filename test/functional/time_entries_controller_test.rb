...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { comment: @time_entry.comment, date: @time_entry.date, end_time: @time_entry.end_time, start_time: @time_entry.start_time }
    end
  ...
  test "should update time_entry" do
    put :update, id: @time_entry, time_entry: { comment: @time_entry.comment, date: @time_entry.date, end_time: @time_entry.end_time, start_time: @time_entry.start_time }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
